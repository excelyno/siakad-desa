# 🏛️ SIAKAD Desa - Sistem Informasi Administrasi Desa
...
│   ├── dashboard/       # Halaman User (Profile, History, Request)
│   ├── admin/           # Halaman Admin
│   ├── login/           # Auth Pages
│   └── layout.tsx       # Root Layout
├── components/          # Komponen UI (Card, Button, Navbar)
│   ├── ui/              # Shadcn UI Components
│   └── PrintButton.tsx  # Komponen Cetak
├── lib/                 # Utilitas lama (Deprecated)
├── utils/               
│   └── supabase/        # Supabase Client (Singleton Pattern)
